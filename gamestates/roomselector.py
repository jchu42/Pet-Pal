...
class RoomSelector(GameState):
    ...
    def __init__(self, username, petname)->None:
        ...
        self.room_selector.lessthan.set_pos((5, 59)).set_origin((0.5, 1))
        self.room_selector.morethan.set_pos((55, 59)).set_origin((0.5, 1))
        ...
        self.border_selector.lessthan.set_pos((5, 69)).set_origin((0.5, 1))
        self.border_selector.morethan.set_pos((55, 69)).set_origin((0.5, 1))
