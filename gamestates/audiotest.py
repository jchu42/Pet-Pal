...
class AudioTest(GameState):
    ...
    def __init__(self)->None:
        ...
        self.pitch.set_pos((30, 14)).set_muted(True)
        ...
        self._add_game_object(GameObject ()).set_image_text("INSTRUMENT").set_pos((30, 22))
        ...
        self._add_game_object(GameObject ()).set_image_text("VOLUME").set_pos((30, 37))
        self.volume = Selector([x*4 for x in range(32)], 25, color=(255, 0, 0, 255))
        self.volume.set_pos((30, 44)).set_muted(True)
        ...
        self.play_button = GameObject().set_pos((30, 52)).set_image_text("PLAY", (255, 0, 255, 255))
